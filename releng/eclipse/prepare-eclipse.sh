...
if [ ! -d "$ECLIPSE_HOME" ]; then
  read -p "Your eclipse home is not existing. Do you want to download eclipse? (y or n) " install
  ...
  if [[ "$OSTYPE" == "linux-gnu" ]]; then
    ...
    wget -O ./tmp-eclipse-download/eclipse.tar.gz https://www.eclipse.org/downloads/download.php?file=/technology/epp/downloads/release/2024-06/R/eclipse-java-2024-06-R-linux-gtk-x86_64.tar.gz
  ...
  if [[ "$OSTYPE" == "darwin"* ]]; then
    ...
    wget -O ./eclipse.dmg https://www.eclipse.org/downloads/download.php?file=/technology/epp/downloads/release/2024-06/R/eclipse-java-2024-06-R-macosx-cocoa-x86_64.dmg
  ...
  if [[ "$OSTYPE" == "msys" || "$OSTYPE" == "cygwin" || "$OSTYPE" == "win32" ]]; then
    ...
    mkdir ./tmp-eclipse-download
    wget -O ./tmp-eclipse-download/eclipse.zip https://www.eclipse.org/downloads/download.php?file=/technology/epp/downloads/release/2024-06/R/eclipse-java-2024-06-R-win32-x86_64.zip
...
if [ $eclipseBuildId != "eclipse.buildId=4.32.0.20240606-1231" ]; then
  echo "You are using a different version than the preferred version 2024-06 (4.32) of eclipse: ${eclipseBuildId}."
