...
if [ ! -z "$askForInstall" ]; then
  ...
  if [[ "$OSTYPE" == "linux-gnu" ]]; then
    ...
    curl -o ./tmp-eclipse-download/eclipse.tar.gz https://archive.eclipse.org/technology/epp/downloads/release/2025-12/R/eclipse-java-2025-12-R-linux-gtk-x86_64.tar.gz
  ...
  if [[ "$OSTYPE" == "darwin"* ]]; then
    ...
    curl -o ./eclipse.dmg https://archive.eclipse.org/technology/epp/downloads/release/2025-12/R/eclipse-java-2025-12-R-macosx-cocoa-x86_64.dmg
  ...
  if [[ "$OSTYPE" == "msys" || "$OSTYPE" == "cygwin" || "$OSTYPE" == "win32" ]]; then
    ...
    mkdir ./tmp-eclipse-download
    curl -o ./tmp-eclipse-download/eclipse.zip https://archive.eclipse.org/technology/epp/downloads/release/2025-12/R/eclipse-java-2025-12-R-win32-x86_64.zip
