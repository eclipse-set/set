...
- Name: pphn.spec.ts >> total view displaying
- Location: tests\pphn.spec.ts:25:1

# Error details

```
Error: A snapshot doesn't exist at C:\ws_intern\planpro\set\web\siteplan\tests\pphn.spec.ts-snapshots\pphn-total-view-chromium-win32.png, writing actual.
```
