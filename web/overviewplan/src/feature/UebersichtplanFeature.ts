...
/**
 * Uebersichtplan Feature interface
 * @author Truong
 */
export interface IUebersichtplanFeature {
  map: OlMap
...
export default abstract class UebersichtplanFeature<T extends SiteplanObject> implements IUebersichtplanFeature {
  map: OlMap
