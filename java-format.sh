...
$1 -noSplash -vm "$JAVA_HOME/javaw.exe" -data ./java-format-workspace/ -application org.eclipse.jdt.core.JavaCodeFormatter -config ./releng/eclipse/java-formatter.epf .

# TODO:
# $1 -noSplash -vm "$JAVA_HOME/javaw.exe" -data ./java-format-workspace/ -application org.eclipse.xtend.core.formatting.XtendFormatter -config ./releng/eclipse/xtend-formatter.epf .
