...
/**
 * Part description for web siteplan view.
 * 
 * @author Schaefer
 */
@Component
public class WebSiteplanDescriptionService implements PartDescriptionService {
	...
	public PartDescription getDescription(final IEclipseContext context) {
		...
		return new PartDescription(
				...
				// contributionURI
				"bundleclass://org.eclipse.set.feature.siteplan/org.eclipse.set.feature.siteplan.parts.WebSiteplanPart", //$NON-NLS-1$
				// toolboxViewName
				injectionHelper.messages.WebSiteplanDescriptionService_ViewName,
				// toolboxViewToolTip
				"", //$NON-NLS-1$
				// toolboxViewType
				getToolboxViewGroup(),
	...
	public ToolboxViewGroup getToolboxViewGroup() {
		return SetViewGroups.getSiteplan();
	}
}
