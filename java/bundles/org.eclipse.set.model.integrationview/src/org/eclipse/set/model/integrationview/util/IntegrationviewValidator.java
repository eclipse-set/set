...
public class IntegrationviewValidator extends EObjectValidator {
	...
	protected boolean validate(int classifierID, Object value,
		...
		switch (classifierID) {
			case IntegrationviewPackage.INTEGRATION_VIEW:
				return validateIntegrationView((IntegrationView) value,
						diagnostics, context);
			case IntegrationviewPackage.OBJECT_QUANTITY:
				return validateObjectQuantity((ObjectQuantity) value,
						diagnostics, context);
	 ...
	 * @generated
	 */
	public boolean validateIntegrationView(IntegrationView integrationView,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate_EveryDefaultConstraint(integrationView, diagnostics,
				context);
	}
	...
	public boolean validateObjectQuantity(ObjectQuantity objectQuantity,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate_EveryDefaultConstraint(objectQuantity, diagnostics,
				context);
	}
	 ...
	 * @generated
	 */
	public boolean validateDetails(Details details, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		if (!validate_NoCircularContainment(details, diagnostics, context))
			return false;
		boolean result = validate_EveryMultiplicityConforms(details,
				diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryDataValueConforms(details, diagnostics,
					context);
		if (result || diagnostics != null)
			result &= validate_EveryReferenceIsContained(details, diagnostics,
					context);
		if (result || diagnostics != null)
			result &= validate_EveryBidirectionalReferenceIsPaired(details,
					diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryProxyResolves(details, diagnostics,
					context);
		if (result || diagnostics != null)
			result &= validate_UniqueID(details, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryKeyUnique(details, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryMapEntryUnique(details, diagnostics,
					context);
		if (result || diagnostics != null)
			result &= validateDetails_equalPlanningValues(details, diagnostics,
					context);
		return result;
	}
	 ...
	 * @generated NOT
	 */
	public boolean validateDetails_equalPlanningValues(Details details,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!StringExtensions.nullSafeEquals(details.getValuePrimaryPlanning(),
				details.getValueSecondaryPlanning())) {
			if (diagnostics != null) {
				diagnostics.add(createDiagnostic(Diagnostic.ERROR,
						DIAGNOSTIC_SOURCE, 1,
						"message_validateDetails_equalPlanningValues",
						new Object[] { "equalPlanningValues",
								getObjectLabel(details, context) },
						new Object[] { details,
								IntegrationviewPackage.eINSTANCE
