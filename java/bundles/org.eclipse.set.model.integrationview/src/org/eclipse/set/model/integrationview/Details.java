 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.set.model.integrationview.Details#getAttributePath
 * <em>Attribute Path</em>}</li>
 * <li>{@link org.eclipse.set.model.integrationview.Details#getValuePrimaryPlanning
 * <em>Value Primary Planning</em>}</li>
 * <li>{@link org.eclipse.set.model.integrationview.Details#getValueSecondaryPlanning
...
public interface Details extends EObject {
	 ...
	 * <em>Attribute Path</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Attribute Path</em>' attribute.
	...
	/**
	 * Returns the value of the '<em><b>Value Primary Planning</b></em>'
	 * attribute. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Value Primary Planning</em>' attribute isn't
	 ...
	 * <em>Value Primary Planning</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Value Primary Planning</em>'
	 *            attribute.
	...
	/**
	 * Returns the value of the '<em><b>Value Secondary Planning</b></em>'
	 * attribute. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Value Secondary Planning</em>' attribute isn't
	 * clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * <em>Value Secondary Planning</em>}' attribute. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Value Secondary Planning</em>'
	 *            attribute.
