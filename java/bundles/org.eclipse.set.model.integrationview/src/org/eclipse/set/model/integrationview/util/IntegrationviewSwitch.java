...
public class IntegrationviewSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case IntegrationviewPackage.INTEGRATION_VIEW: {
				IntegrationView integrationView = (IntegrationView)theEObject;
				T result = caseIntegrationView(integrationView);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IntegrationviewPackage.OBJECT_QUANTITY: {
				ObjectQuantity objectQuantity = (ObjectQuantity)theEObject;
				T result = caseObjectQuantity(objectQuantity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Integration View</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Integration View</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseIntegrationView(IntegrationView object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Object Quantity</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Object Quantity</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseObjectQuantity(ObjectQuantity object) {
		return null;
	}
