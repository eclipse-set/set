...
public class IntegrationviewSwitch<T> extends Switch<T> {
	 ...
	 * '<em>Integration View</em>'. <!-- begin-user-doc --> This implementation
	...
	/**
	 * Returns the result of interpreting the object as an instance of
	 * '<em>Object Quantity</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
	...
	/**
	 * Returns the result of interpreting the object as an instance of
	 * '<em>Conflict</em>'. <!-- begin-user-doc --> This implementation returns
	...
	/**
	 * Returns the result of interpreting the object as an instance of
	 * '<em>Details</em>'. <!-- begin-user-doc --> This implementation returns
	 * null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
