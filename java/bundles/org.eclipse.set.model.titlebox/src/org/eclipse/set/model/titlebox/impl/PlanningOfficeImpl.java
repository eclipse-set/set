...
public class PlanningOfficeImpl extends MinimalEObjectImpl.Container
	 ...
	 * @generated
	 */
	public NotificationChain basicSetEmail(final StringField newEmail,
			NotificationChain msgs) {
		final StringField oldEmail = email;
		email = newEmail;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetGroup(final StringField newGroup,
			NotificationChain msgs) {
		final StringField oldGroup = group;
		group = newGroup;
		if (eNotificationRequired()) {
			final ENotificationImpl notification = new ENotificationImpl(this,
	 ...
	 * @generated
	 */
	public NotificationChain basicSetLocation(final StringField newLocation,
			NotificationChain msgs) {
		final StringField oldLocation = location;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetName(final StringField newName,
			NotificationChain msgs) {
		final StringField oldName = name;
		name = newName;
		if (eNotificationRequired()) {
			final ENotificationImpl notification = new ENotificationImpl(this,
	 ...
	 * @generated
	 */
	public NotificationChain basicSetPhone(final StringField newPhone,
			NotificationChain msgs) {
		final StringField oldPhone = phone;
		phone = newPhone;
		if (eNotificationRequired()) {
			final ENotificationImpl notification = new ENotificationImpl(this,
	 ...
	 */
	@Override
	public void setEmail(final StringField newEmail) {
		if (newEmail != email) {
	 ...
	 */
	@Override
	public void setGroup(final StringField newGroup) {
		if (newGroup != group) {
			NotificationChain msgs = null;
			if (group != null) {
	 ...
	 */
	@Override
	public void setLocation(final StringField newLocation) {
	 ...
	 */
	@Override
	public void setLogo(final String newLogo) {
		final String oldLogo = logo;
		logo = newLogo;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET,
	 ...
	 */
	@Override
	public void setName(final StringField newName) {
		if (newName != name) {
			NotificationChain msgs = null;
			if (name != null) {
	 ...
	 */
	@Override
	public void setPhone(final StringField newPhone) {
		if (newPhone != phone) {
			NotificationChain msgs = null;
			if (phone != null) {
	 ...
	 */
	@Override
	public void setVariant(final String newVariant) {
		final String oldVariant = variant;
		variant = newVariant;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET,
