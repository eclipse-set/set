 ...
 * @generated
 */
public class SimplemergePackageImpl extends EPackageImpl implements SimplemergePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 *
	 * <p>This method is used to initialize {@link SimplemergePackage#eINSTANCE} when that field is accessed.
	...
	public static SimplemergePackage init() {
		if (isInited) return (SimplemergePackage)EPackage.Registry.INSTANCE.getEPackage(SimplemergePackage.eNS_URI);

		// Obtain or create and register package
		Object registeredSimplemergePackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		SimplemergePackageImpl theSimplemergePackage = registeredSimplemergePackage instanceof SimplemergePackageImpl ? (SimplemergePackageImpl)registeredSimplemergePackage : new SimplemergePackageImpl();
		...
		EPackage.Registry.INSTANCE.put(SimplemergePackage.eNS_URI, theSimplemergePackage);
	...
	public void initializePackageContents() {
		...
		initEClass(sComparisonEClass, SComparison.class, "SComparison", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSComparison_Matches(), this.getSMatch(), null, "matches", null, 0, -1, SComparison.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(sMatchEClass, SMatch.class, "SMatch", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSMatch_Id(), ecorePackage.getEInt(), "id", null, 1, 1, SMatch.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSMatch_GuidPrimary(), ecorePackage.getEString(), "guidPrimary", null, 0, 1, SMatch.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSMatch_GuidSecondary(), ecorePackage.getEString(), "guidSecondary", null, 0, 1, SMatch.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSMatch_Resolution(), this.getResolution(), "resolution", null, 0, 1, SMatch.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSMatch_ElementType(), ecorePackage.getEString(), "elementType", null, 0, 1, SMatch.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
