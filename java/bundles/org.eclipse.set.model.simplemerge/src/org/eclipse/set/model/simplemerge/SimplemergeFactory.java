...
public interface SimplemergeFactory extends EFactory {
	 ...
	 * @generated
	 */
	SimplemergeFactory eINSTANCE = org.eclipse.set.model.simplemerge.impl.SimplemergeFactoryImpl
			.init();

	/**
	 * Returns a new object of class '<em>SComparison</em>'. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>SMatch</em>'. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
