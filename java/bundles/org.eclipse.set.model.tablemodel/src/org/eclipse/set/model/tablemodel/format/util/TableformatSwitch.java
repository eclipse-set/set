 ...
 * @generated
 */
public class TableformatSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TableformatPackage.CELL_FORMAT: {
				...
				if (result == null)
					result = caseCellAnnotation(cellFormat);
				if (result == null)
	 ...
	 * Format</em>'. <!-- begin-user-doc --> This implementation returns null;
