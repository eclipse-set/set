...
public class CompareTableCellContentImpl extends CellContentImpl
	 ...
	 * @ordered
	 */
	protected CompareCellContent firstPlanCellContent;
	 ...
	 * @ordered
	 */
	protected CompareCellContent secondPlanCellContent;
	 ...
	 */
	@Override
	public CompareCellContent getFirstPlanCellContent() {
	...
	public NotificationChain basicSetFirstPlanCellContent(
			CompareCellContent newFirstPlanCellContent,
			NotificationChain msgs) {
		CompareCellContent oldFirstPlanCellContent = firstPlanCellContent;
	 ...
	 */
	@Override
	public void setFirstPlanCellContent(
			CompareCellContent newFirstPlanCellContent) {
	 ...
	 */
	@Override
	public CompareCellContent getSecondPlanCellContent() {
	...
	public NotificationChain basicSetSecondPlanCellContent(
			CompareCellContent newSecondPlanCellContent,
			NotificationChain msgs) {
		CompareCellContent oldSecondPlanCellContent = secondPlanCellContent;
	 ...
	 */
	@Override
	public void setSecondPlanCellContent(
			CompareCellContent newSecondPlanCellContent) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case TablemodelPackage.COMPARE_TABLE_CELL_CONTENT__FIRST_PLAN_CELL_CONTENT:
				setFirstPlanCellContent((CompareCellContent) newValue);
				return;
			case TablemodelPackage.COMPARE_TABLE_CELL_CONTENT__SECOND_PLAN_CELL_CONTENT:
				setSecondPlanCellContent((CompareCellContent) newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case TablemodelPackage.COMPARE_TABLE_CELL_CONTENT__FIRST_PLAN_CELL_CONTENT:
				setFirstPlanCellContent((CompareCellContent) null);
				return;
			case TablemodelPackage.COMPARE_TABLE_CELL_CONTENT__SECOND_PLAN_CELL_CONTENT:
				setSecondPlanCellContent((CompareCellContent) null);
				return;
		}
