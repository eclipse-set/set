...
public interface TableformatPackage extends EPackage {
	 ...
	 * @generated
	 */
	TableformatPackage eINSTANCE = org.eclipse.set.model.tablemodel.format.impl.TableformatPackageImpl.init();

	/**
	 * The meta object id for the '{@link org.eclipse.set.model.tablemodel.format.impl.CellFormatImpl <em>Cell Format</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	int CELL_FORMAT__TEXT_ALIGNMENT = TablemodelPackage.CELL_ANNOTATION_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int CELL_FORMAT_FEATURE_COUNT = TablemodelPackage.CELL_ANNOTATION_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int CELL_FORMAT_OPERATION_COUNT = TablemodelPackage.CELL_ANNOTATION_OPERATION_COUNT + 0;

	/**
	 * The meta object id for the '{@link org.eclipse.set.model.tablemodel.format.TextAlignment <em>Text Alignment</em>}' enum.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for class '{@link org.eclipse.set.model.tablemodel.format.CellFormat <em>Cell Format</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the attribute '{@link org.eclipse.set.model.tablemodel.format.CellFormat#getTextAlignment <em>Text Alignment</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for enum '{@link org.eclipse.set.model.tablemodel.format.TextAlignment <em>Text Alignment</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link org.eclipse.set.model.tablemodel.format.impl.CellFormatImpl <em>Cell Format</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see org.eclipse.set.model.tablemodel.format.impl.CellFormatImpl
		 * @see org.eclipse.set.model.tablemodel.format.impl.TableformatPackageImpl#getCellFormat()
		 ...
		 * @generated
		 */
		EAttribute CELL_FORMAT__TEXT_ALIGNMENT = eINSTANCE.getCellFormat_TextAlignment();

		/**
		 * The meta object literal for the '{@link org.eclipse.set.model.tablemodel.format.TextAlignment <em>Text Alignment</em>}' enum.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see org.eclipse.set.model.tablemodel.format.TextAlignment
		 * @see org.eclipse.set.model.tablemodel.format.impl.TableformatPackageImpl#getTextAlignment()
