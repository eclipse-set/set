...
public class TablemodelPackageImpl extends EPackageImpl
	...
	public void initializePackageContents() {
		...
		initEReference(getCompareTableCellContent_FirstPlanCellContent(),
				this.getCompareCellContent(), null, "firstPlanCellContent",
				null, 0, 1, CompareTableCellContent.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCompareTableCellContent_SecondPlanCellContent(),
				this.getCompareCellContent(), null, "secondPlanCellContent",
				null, 0, 1, CompareTableCellContent.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
