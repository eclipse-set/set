...
public class PlazPackageImpl extends EPackageImpl implements PlazPackage {
	 ...
	 *
	 * <p>
	 * This method is used to initialize {@link PlazPackage#eINSTANCE} when that
	...
	public static PlazPackage init() {
		if (isInited)
			return (PlazPackage) EPackage.Registry.INSTANCE
					.getEPackage(PlazPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredPlazPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		PlazPackageImpl thePlazPackage = registeredPlazPackage instanceof PlazPackageImpl
				? (PlazPackageImpl) registeredPlazPackage
				: new PlazPackageImpl();
	...
	public void initializePackageContents() {
		...
		ValidationreportPackage theValidationreportPackage = (ValidationreportPackage) EPackage.Registry.INSTANCE
		...
		initEClass(plazReportEClass, PlazReport.class, "PlazReport",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPlazReport_Entries(),
				theValidationreportPackage.getValidationProblem(), null,
				"entries", null, 0, -1, PlazReport.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(plazErrorEClass, PlazError.class, "PlazError", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getPlazError_Type(), ecorePackage.getEString(), "type",
				null, 0, 1, PlazError.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getPlazError_Message(), ecorePackage.getEString(),
				"message", null, 0, 1, PlazError.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getPlazError_Severity(),
				theValidationreportPackage.getValidationSeverity(), "severity",
				null, 0, 1, PlazError.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getPlazError_Object(), ecorePackage.getEObject(), null,
				"object", null, 0, 1, PlazError.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
