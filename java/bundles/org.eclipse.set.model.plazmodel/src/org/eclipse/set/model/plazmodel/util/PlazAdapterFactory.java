...
public class PlazAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected PlazSwitch<Adapter> modelSwitch =
		new PlazSwitch<Adapter>() {
			@Override
			public Adapter casePlazReport(PlazReport object) {
				return createPlazReportAdapter();
			}
			@Override
			public Adapter casePlazError(PlazError object) {
				return createPlazErrorAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.set.model.plazmodel.PlazReport <em>Report</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.set.model.plazmodel.PlazError <em>Error</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
