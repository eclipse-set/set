 ...
 * @generated
 */
public class ZipmanifestPackageImpl extends EPackageImpl implements ZipmanifestPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 *
	 * <p>This method is used to initialize {@link ZipmanifestPackage#eINSTANCE} when that field is accessed.
	...
	public static ZipmanifestPackage init() {
		if (isInited) return (ZipmanifestPackage)EPackage.Registry.INSTANCE.getEPackage(ZipmanifestPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredZipmanifestPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		ZipmanifestPackageImpl theZipmanifestPackage = registeredZipmanifestPackage instanceof ZipmanifestPackageImpl ? (ZipmanifestPackageImpl)registeredZipmanifestPackage : new ZipmanifestPackageImpl();
		...
		EPackage.Registry.INSTANCE.put(ZipmanifestPackage.eNS_URI, theZipmanifestPackage);
	...
	public void initializePackageContents() {
		...
		initEReference(getDocumentRoot_Manifest(), this.getManifest(), null, "manifest", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);

		initEClass(manifestEClass, Manifest.class, "Manifest", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getManifest_ContentList(), this.getContentList(), null, "contentList", null, 1, 1, Manifest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getManifest_MediaList(), this.getMediaList(), null, "mediaList", null, 1, 1, Manifest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getContentList_Content(), this.getContent(), null, "content", null, 0, -1, ContentList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(mediaListEClass, MediaList.class, "MediaList", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getMediaList_Media(), this.getMedia(), null, "media", null, 0, -1, MediaList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(mediaEClass, Media.class, "Media", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getMedia_Guid(), ecorePackage.getEString(), "guid", null, 0, 1, Media.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
