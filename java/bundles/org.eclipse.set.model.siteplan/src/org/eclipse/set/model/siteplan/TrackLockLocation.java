...
public enum TrackLockLocation implements Enumerator {
	/**
	 * The '<em><b>Beside Track</b></em>' literal object. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The '<em><b>On Track</b></em>' literal object. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @see #ON_TRACK_VALUE
	 * @generated
	...
	/**
	 * The '<em><b>Beside Track</b></em>' literal value. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @see #BESIDE_TRACK
	...
	/**
	 * The '<em><b>On Track</b></em>' literal value. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @see #ON_TRACK
	 * @model name="OnTrack"
	...
	private static final TrackLockLocation[] VALUES_ARRAY = new TrackLockLocation[] {
			BESIDE_TRACK, ON_TRACK, };

	/**
	 * A public read-only list of all the '<em><b>Track Lock Location</b></em>'
	 * enumerators. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	public static final List<TrackLockLocation> VALUES = Collections
			.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Track Lock Location</b></em>' literal with the
