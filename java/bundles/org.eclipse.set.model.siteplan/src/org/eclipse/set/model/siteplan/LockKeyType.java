...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Lock Key Type</b></em>',
...
public enum LockKeyType implements Enumerator {
	 ...
	 * @generated
	 */
	private static final LockKeyType[] VALUES_ARRAY =
		new LockKeyType[] {
			INSIDE,
			OUTSIDE,
		};
	...
	/**
	 * A public read-only list of all the '<em><b>Lock Key Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<LockKeyType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Lock Key Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the '<em><b>Lock Key Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	...
	/**
	 * Returns the '<em><b>Lock Key Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
