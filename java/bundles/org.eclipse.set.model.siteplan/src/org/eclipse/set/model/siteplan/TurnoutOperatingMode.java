...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Turnout Operating Mode</b></em>',
...
public enum TurnoutOperatingMode implements Enumerator {
	 ...
	 * @generated
	 */
	private static final TurnoutOperatingMode[] VALUES_ARRAY =
		new TurnoutOperatingMode[] {
			UNDEFINED,
			ELECTRIC_REMOTE,
			ELECTRIC_LOCAL,
			MECHANICAL_REMOTE,
