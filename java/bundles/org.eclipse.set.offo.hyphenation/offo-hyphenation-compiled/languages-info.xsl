    ...
    <div id="footer">
      <table cellpadding="4" cellspacing="0" border="0">
        <tr>
          ...
          <td><a href="http://opensource.org/licenses"> Copyright © 2004–2016 OFFO</a> All rights reserved.<br/>
            <script type="text/javascript" language="JavaScript"><!--
              document.write(" - " + "Last Published: " + document.lastModified);
              //--></script>
            <div id="feedback"> Send feedback about the website to <a id="feedbackto"
                href="mailto:spepping@sourceforge.net?subject=Feedback about OFFO%C2%A0languages-info.xml"
