...
/**
 * Part description for web news part.
 * 
 * @author Truong
 *
 */
@Component(service = PartDescriptionService.class)
public class WebNewsPartDescriptionService implements PartDescriptionService {
	...
	public PartDescription getDescription(final IEclipseContext context) {
		...
		return new PartDescription(
				// ID
				ToolboxConstants.WEB_NEWS_PART_ID,
				// contributionURI
				"bundleclass://org.eclipse.set.application/org.eclipse.set.application.nosessionpart.WebNewsPart", //$NON-NLS-1$
				// toolboxViewName
				injectionHelper.messages.WebNewsPartDescriptionService_ViewName,
				// toolboxViewToolTip
				"", //$NON-NLS-1$
				// toolboxViewType
				getToolboxViewGroup(),
