 ...
 * @generated
 */
public class ValidationreportPackageImpl extends EPackageImpl
		implements ValidationreportPackage {
	/**
	 ...
	 * {@link ValidationreportPackage#eINSTANCE} when that field is accessed.
	...
	public static ValidationreportPackage init() {
		if (isInited)
			return (ValidationreportPackage) EPackage.Registry.INSTANCE
					.getEPackage(ValidationreportPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredValidationreportPackage = EPackage.Registry.INSTANCE
				.get(eNS_URI);
		ValidationreportPackageImpl theValidationreportPackage = registeredValidationreportPackage instanceof ValidationreportPackageImpl
				? (ValidationreportPackageImpl) registeredValidationreportPackage
				: new ValidationreportPackageImpl();
		...
		EPackage.Registry.INSTANCE.put(ValidationreportPackage.eNS_URI,
				theValidationreportPackage);
	...
	public EAttribute getValidationReport_ModelLoaded() {
		return (EAttribute) validationReportEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public EReference getValidationReport_Problems() {
		return (EReference) validationReportEClass.getEStructuralFeatures()
				.get(4);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(validationReportEClass,
				VALIDATION_REPORT__MODEL_LOADED);
		...
		createEReference(validationReportEClass,
				VALIDATION_REPORT__SUPPORTED_VERSION);
		createEAttribute(validationReportEClass,
				VALIDATION_REPORT__TOOLBOX_VERSION);
		createEAttribute(validationReportEClass,
				VALIDATION_REPORT__SUBWORK_COUNT);
		createEAttribute(validationReportEClass,
				VALIDATION_REPORT__SUBWORK_TYPES);
		...
		createEAttribute(validationProblemEClass,
				VALIDATION_PROBLEM__SEVERITY_TEXT);
		createEAttribute(validationProblemEClass,
				VALIDATION_PROBLEM__LINE_NUMBER);
		...
		createEAttribute(validationProblemEClass,
				VALIDATION_PROBLEM__OBJECT_STATE);
		createEAttribute(validationProblemEClass,
	...
	public void initializePackageContents() {
		...
		initEClass(validationReportEClass, ValidationReport.class,
				"ValidationReport", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getValidationReport_ModelLoaded(),
				ecorePackage.getEString(), "modelLoaded", null, 0, 1,
				ValidationReport.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getValidationReport_Valid(), ecorePackage.getEString(),
				"valid", null, 0, 1, ValidationReport.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getValidationReport_XsdValid(),
				ecorePackage.getEString(), "xsdValid", null, 0, 1,
				ValidationReport.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getValidationReport_EmfValid(),
				ecorePackage.getEString(), "emfValid", null, 0, 1,
				ValidationReport.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getValidationReport_Problems(),
				this.getValidationProblem(), null, "problems", null, 0, -1,
				ValidationReport.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getValidationReport_SupportedVersion(),
				this.getVersionInfo(), null, "supportedVersion", null, 1, 1,
				ValidationReport.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getValidationReport_ToolboxVersion(),
				ecorePackage.getEString(), "toolboxVersion", null, 0, 1,
				ValidationReport.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getValidationReport_SubworkCount(),
				ecorePackage.getEString(), "subworkCount", null, 0, 1,
				ValidationReport.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getValidationReport_SubworkTypes(),
				ecorePackage.getEString(), "subworkTypes", null, 0, 1,
				ValidationReport.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getValidationReport_FileInfo(), this.getFileInfo(), null,
				"fileInfo", null, 0, 1, ValidationReport.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(validationProblemEClass, ValidationProblem.class,
				"ValidationProblem", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getValidationProblem_Id(), ecorePackage.getEInt(), "id",
				null, 0, 1, ValidationProblem.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getValidationProblem_Type(), ecorePackage.getEString(),
				"type", null, 0, 1, ValidationProblem.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getValidationProblem_Severity(),
				this.getValidationSeverity(), "severity", null, 0, 1,
				ValidationProblem.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getValidationProblem_SeverityText(),
				ecorePackage.getEString(), "severityText", null, 0, 1,
				ValidationProblem.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getValidationProblem_LineNumber(),
				ecorePackage.getEInt(), "lineNumber", null, 0, 1,
				ValidationProblem.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getValidationProblem_Message(),
				ecorePackage.getEString(), "message", null, 0, 1,
				ValidationProblem.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		...
		initEAttribute(getValidationProblem_AttributeName(),
				...
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getValidationProblem_ObjectScope(),
				this.getObjectScope(), "objectScope", "", 0, 1,
				ValidationProblem.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getValidationProblem_ObjectState(),
				this.getObjectState(), "objectState", "", 0, 1,
				ValidationProblem.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getValidationProblem_GeneralMsg(),
				ecorePackage.getEString(), "generalMsg", null, 0, 1,
				ValidationProblem.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		...
		initEAttribute(getFileInfo_FileName(), ecorePackage.getEString(),
				"fileName", null, 0, 1, FileInfo.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getFileInfo_UsedVersion(), this.getVersionInfo(), null,
				"usedVersion", null, 1, 1, FileInfo.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getFileInfo_Checksum(), ecorePackage.getEString(),
				"checksum", null, 0, 1, FileInfo.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getFileInfo_Guid(), ecorePackage.getEString(), "guid",
				null, 0, 1, FileInfo.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getFileInfo_TimeStamp(), ecorePackage.getEString(),
				"timeStamp", null, 0, 1, FileInfo.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getFileInfo_ContainerContents(),
				ecorePackage.getEString(), "containerContents", null, 0, 1,
				FileInfo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		// Initialize enums and add enum literals
		initEEnum(validationSeverityEEnum, ValidationSeverity.class,
				"ValidationSeverity");
		...
		initEEnum(containerContentEEnum, ContainerContent.class,
				"ContainerContent");
