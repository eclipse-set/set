...
/**
 * Part description for validation view.
 * 
 * @author Schaefer
 */
@Component(immediate = true)
public class ValidationViewDescriptionService
	...
	public PartDescription getDescription(final IEclipseContext context) {
		...
		return new PartDescription(
				// ID
				ToolboxConstants.VALIDATION_PART_ID,
				// contributionURI
				"bundleclass://org.eclipse.set.feature.validation/org.eclipse.set.feature.validation.parts.ValidationPart", //$NON-NLS-1$
				// toolboxViewName
				injectionHelper.messages.ValidationViewDescriptionService_ViewName,
				// toolboxViewToolTip
				"", //$NON-NLS-1$
				// toolboxViewType
				getToolboxViewGroup(),
				// defaultForNature
				PlanProFileNature.INVALID,
