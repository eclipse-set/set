...
/**
 * This is the item provider adapter for a {@link org.eclipse.set.model.validationreport.VersionInfo} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_VersionInfo_planPro_feature", "_UI_VersionInfo_type"),
				 ValidationreportPackage.Literals.VERSION_INFO__PLAN_PRO,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_VersionInfo_signals_feature", "_UI_VersionInfo_type"),
				 ValidationreportPackage.Literals.VERSION_INFO__SIGNALS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
