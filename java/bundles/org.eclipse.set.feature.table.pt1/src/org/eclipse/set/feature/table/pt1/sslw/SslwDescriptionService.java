...
/**
 * Part description for SSLW table view.
 * 
 * @author Schaefer
 */
@Component(service = PartDescriptionService.class)
public class SslwDescriptionService extends AbstractESTWTableDescription {
	@Reference
	Messages messages;

	@Override
	protected String getToolboxViewName() {
		return messages.SslwDescriptionService_ViewName;
	}

	@Override
	protected String getToolboxViewTooltip() {
		return messages.SslwDescriptionService_ViewTooltip;
	}

	@Override
	protected String getTableShortcut() {
		return messages.ToolboxTableNameSslwShort;
	}
}
