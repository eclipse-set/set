...
/**
 * Part description for SSKA table view.
 * 
 * @author Schaefer
 */
@Component(service = PartDescriptionService.class)
public class SskaDescriptionService extends AbstractESTWTableDescription {
	@Reference
	Messages messages;

	@Override
	protected String getToolboxViewName() {
		return messages.SskaDescriptionService_ViewName;
	}

	@Override
	protected String getToolboxViewTooltip() {
		return messages.SskaDescriptionService_ViewTooltip;
	}

	@Override
	protected String getTableShortcut() {
		return messages.ToolboxTableNameSskaShort;
	}
}
