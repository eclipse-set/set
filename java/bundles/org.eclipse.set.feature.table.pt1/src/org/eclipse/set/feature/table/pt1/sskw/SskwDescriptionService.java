...
/**
 * Part description for SSKW table view.
 * 
 * @author Schaefer
 */
@Component(service = PartDescriptionService.class)
public class SskwDescriptionService extends AbstractESTWTableDescription {
	@Reference
	Messages messages;

	@Override
	protected String getToolboxViewName() {
		return messages.SskwDescriptionService_ViewName;
	}

	@Override
	protected String getToolboxViewTooltip() {
		return messages.SskwDescriptionService_ViewTooltip;
	}

	@Override
	protected String getTableShortcut() {
		return messages.ToolboxTableNameSskwShort;
	}
}
