...
/**
 * Part description for SSVU table view.
 * 
 * @author Schaefer
 */
@Component(service = PartDescriptionService.class)
public class SsvuDescriptionService extends AbstractESTWTableDescription {
	@Reference
	Messages messages;

	@Override
	protected String getToolboxViewName() {
		return messages.SsvuDescriptionService_ViewName;
	}

	@Override
	protected String getToolboxViewTooltip() {
		return messages.SsvuDescriptionService_ViewTooltip;
	}

	@Override
	protected String getTableShortcut() {
		return messages.ToolboxTableNameSsvuShort;
	}
}
