...
/**
 * Part description for SSLB table view.
 * 
 * @author Schaefer
 */
@Component(service = PartDescriptionService.class)
public class SslbDescriptionService extends AbstractESTWTableDescription {
	@Reference
	Messages messages;

	@Override
	protected String getToolboxViewName() {
		return messages.SslbDescriptionService_ViewName;
	}

	@Override
	protected String getToolboxViewTooltip() {
		return messages.SslbDescriptionService_ViewTooltip;
	}

	@Override
	protected String getTableShortcut() {
		return messages.ToolboxTableNameSslbShort;
	}
}
