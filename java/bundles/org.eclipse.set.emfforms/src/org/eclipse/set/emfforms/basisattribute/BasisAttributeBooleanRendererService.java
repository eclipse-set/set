...
/**
 * Check if the {@link BasisAttributeBooleanRenderer} should be used and provide
 * the renderer class.
 *
 * @author Schaefer
 * 
...
public class BasisAttributeBooleanRendererService extends
		DomainModelTypeRendererService<BasisAttribut_AttributeGroup, BasisAttributeBooleanRenderer> {
	 ...
	 * Create the service.
	 */
	public BasisAttributeBooleanRendererService() {
		super(PlanProPackage.eINSTANCE, BasisAttribut_AttributeGroup.class,
				BasisAttributeBooleanRenderer.class, PRIORITY,
				Multiplicity.ZERO_OR_ONE,
				BasisAttributeBooleanRenderer::isApplicable);
	}
}
