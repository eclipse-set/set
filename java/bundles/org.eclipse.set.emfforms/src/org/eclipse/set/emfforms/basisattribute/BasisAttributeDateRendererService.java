...
/**
 * Check if the {@link BasisAttributeDateRenderer} should be used and provide
 * the renderer class.
 *
 * @author Schaefer
 * 
...
public class BasisAttributeDateRendererService extends
		DomainModelTypeRendererService<BasisAttribut_AttributeGroup, BasisAttributeDateRenderer> {
	 ...
	 * Create the service.
	 */
	public BasisAttributeDateRendererService() {
		super(PlanProPackage.eINSTANCE, BasisAttribut_AttributeGroup.class,
				BasisAttributeDateRenderer.class, PRIORITY,
				Multiplicity.ZERO_OR_ONE,
				BasisAttributeDateRenderer::isApplicable);
	}
}
