 ...
 * @generated
 */
public class TemporaryintegrationSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public TemporaryintegrationSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TemporaryintegrationPackage.TEMPORARY_INTEGRATION: {
				TemporaryIntegration temporaryIntegration = (TemporaryIntegration) theEObject;
				T result = caseTemporaryIntegration(temporaryIntegration);
				if (result == null)
			...
			case TemporaryintegrationPackage.TOOLBOX_TEMPORARY_INTEGRATION: {
				...
				T result = caseToolboxTemporaryIntegration(
	 ...
	 * '<em>Temporary Integration</em>'. <!-- begin-user-doc --> This
	 ...
	 *            the target of the switch.
	 * @return the result of interpreting the object as an instance of
	 *         '<em>Toolbox Temporary Integration</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseToolboxTemporaryIntegration(
