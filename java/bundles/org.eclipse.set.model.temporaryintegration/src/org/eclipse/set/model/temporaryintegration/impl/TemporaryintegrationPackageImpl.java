...
public class TemporaryintegrationPackageImpl extends EPackageImpl
	 ...
	 */
	@Override
	public EReference getTemporaryIntegration_PrimaryLayout() {
		return (EReference) temporaryIntegrationEClass.getEStructuralFeatures()
				.get(2);
	}
	 ...
	 */
	@Override
	public EReference getTemporaryIntegration_SecondaryLayout() {
		return (EReference) temporaryIntegrationEClass.getEStructuralFeatures()
				.get(5);
	}
	 ...
	 */
	@Override
	public EReference getTemporaryIntegration_Compositeyout() {
		return (EReference) temporaryIntegrationEClass.getEStructuralFeatures()
				.get(9);
	}
	...
	public void createPackageContents() {
		...
		createEReference(temporaryIntegrationEClass,
				TEMPORARY_INTEGRATION__PRIMARY_LAYOUT);
		createEAttribute(temporaryIntegrationEClass,
		...
		createEReference(temporaryIntegrationEClass,
				TEMPORARY_INTEGRATION__COMPOSITEYOUT);
		createEAttribute(temporaryIntegrationEClass,
	...
	public void initializePackageContents() {
		...
		LayoutinformationenPackage theLayoutinformationenPackage = (LayoutinformationenPackage) EPackage.Registry.INSTANCE
				.getEPackage(LayoutinformationenPackage.eNS_URI);
		...
		initEAttribute(getTemporaryIntegration_PrimaryPlanningFilename(),
				...
				IS_ORDERED);
		initEReference(getTemporaryIntegration_PrimaryLayout(),
				theLayoutinformationenPackage.getPlanPro_Layoutinfo(), null,
				"primaryLayout", null, 0, 1, TemporaryIntegration.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		...
		initEReference(getTemporaryIntegration_SecondaryPlanning(),
				...
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getTemporaryIntegration_SecondaryLayout(),
				theLayoutinformationenPackage.getPlanPro_Layoutinfo(), null,
				"secondaryLayout", null, 0, 1, TemporaryIntegration.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		...
		initEReference(getTemporaryIntegration_CompositePlanning(),
				...
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getTemporaryIntegration_Compositeyout(),
				theLayoutinformationenPackage.getPlanPro_Layoutinfo(), null,
				"compositeyout", null, 0, 1, TemporaryIntegration.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
