	...
	<xsl:template match="Table[Rows/Row]">
		<fo:block>
			<fo:table table-layout="fixed" width="100%">
				...
				<!--  -->
				<fo:table-column column-number="2" column-width="1.91cm" />
				<!-- A -->
				<fo:table-column column-number="3" column-width="1.11cm" />
				<!-- B -->
				<fo:table-column column-number="4" column-width="1.11cm" />
				<!-- C -->
				<fo:table-column column-number="5" column-width="1.19cm" />
				<!-- D -->
				<fo:table-column column-number="6" column-width="1.32cm" />
				<!-- E -->
				<fo:table-column column-number="7" column-width="1.43cm" />
				<!-- F -->
				<fo:table-column column-number="8" column-width="1.35cm" />
				<!-- G -->
				<fo:table-column column-number="9" column-width="1.16cm" />
				<!-- H -->
				<fo:table-column column-number="10" column-width="1.27cm" />
				<!-- I -->
				<fo:table-column column-number="11" column-width="1.27cm" />
				<!-- J -->
				<fo:table-column column-number="12" column-width="1.16cm" />
				<!-- K -->
				<fo:table-column column-number="13" column-width="1.16cm" />
				<!-- L -->
				<fo:table-column column-number="14" column-width="1.16cm" />
				<!-- M -->
				<fo:table-column column-number="15" column-width="1.43cm" />
				<!-- N -->
				<fo:table-column column-number="16" column-width="1.43cm" />
				<!-- O -->
				<fo:table-column column-number="17" column-width="2.41cm" />
				<!-- P -->
				<fo:table-column column-number="18" column-width="2.30cm" />
				<!-- Q -->
				<fo:table-column column-number="19" column-width="1.32cm" />
				<!-- R -->
				<fo:table-column column-number="20" column-width="0.71cm" />
				<!-- S -->
				<fo:table-column column-number="21" column-width="1.14cm" />
				<!-- T -->
				<fo:table-column column-number="22" column-width="2.59cm" />
				<!-- U -->
				<fo:table-column column-number="23" column-width="1.16cm" />
				<!-- V -->
				<fo:table-column column-number="24" column-width="1.69cm" />
				<!-- W -->
				<fo:table-column column-number="25" column-width="1.35cm" />
				<!-- X -->
				<fo:table-column column-number="26" column-width="1.69cm" />
				<!-- Y -->
				<fo:table-column column-number="27" column-width="{1.32  + 1.18}cm" />
				<!-- Z + page filling width-->
				<fo:table-column column-number="28" column-width="0.66cm" />
				<!--  -->
				<fo:table-column column-number="29" column-width="1.91cm" />
				<!-- A -->
				<fo:table-column column-number="30" column-width="0.85cm" />
				<!-- AA -->
				<fo:table-column column-number="31" column-width="0.85cm" />
				<!-- AB -->
				<fo:table-column column-number="32" column-width="0.85cm" />
				<!-- AC -->
				<fo:table-column column-number="33" column-width="0.93cm" />
				<!-- AD -->
				<fo:table-column column-number="34" column-width="0.85cm" />
				<!-- AE -->
				<fo:table-column column-number="35" column-width="0.85cm" />
				<!-- AF -->
				<fo:table-column column-number="36" column-width="0.85cm" />
				<!-- AG -->
				<fo:table-column column-number="37" column-width="0.85cm" />
				<!-- AH -->
				<fo:table-column column-number="38" column-width="0.85cm" />
				<!-- AI -->
				<fo:table-column column-number="39" column-width="0.85cm" />
				<!-- AJ -->
				<fo:table-column column-number="40" column-width="0.85cm" />
				<!-- AK -->
				<fo:table-column column-number="41" column-width="1.69cm" />
				<!-- AL -->
				<fo:table-column column-number="42" column-width="1.69cm" />
				<!-- AM -->
				<fo:table-column column-number="43" column-width="1.46cm" />
				<!-- AN -->
				<fo:table-column column-number="44" column-width="2.65cm" />
				<!-- AO -->
				<fo:table-column column-number="45" column-width="1.67cm" />
				<!-- AP -->
				<fo:table-column column-number="46" column-width="1.43cm" />
				<!-- AQ -->
				<fo:table-column column-number="47" column-width="1.43cm" />
				<!-- AR -->
				<fo:table-column column-number="48" column-width="1.22cm" />
				<!-- AS -->
				<fo:table-column column-number="49" column-width="1.43cm" />
				<!-- AT -->
				<fo:table-column column-number="50" column-width="0.93cm" />
				<!-- AU -->
				<fo:table-column column-number="51" column-width="1.24cm" />
				<!-- AV -->
				<fo:table-column column-number="52" column-width="8.94cm" />
				<!-- AW -->
				...
				<fo:table-header xsl:use-attribute-sets="table-header-style">
					<fo:table-row>
						...
						<fo:table-cell text-align="center" border-left="{$small-border-style}" border-top="{$small-border-style}" border-bottom="none">
						...
						<fo:table-cell text-align="center" border-left="{$small-border-style}" border-right="{$small-border-style}" border-top="{$small-border-style}" border-bottom="none">
					...
					<fo:table-row font-weight="bold" display-align="before">
						...
						<fo:table-cell text-align="center" border-left="{$wide-border-style}" number-rows-spanned="3" border-top="{$wide-border-style}">
							<fo:block start-indent="0mm">Bezeichnung Signal</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="center" border-left="{$wide-border-style}" border-top="{$wide-border-style}" number-columns-spanned="2">
							<fo:block start-indent="0mm">Signal-Art</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="center" border-left="{$wide-border-style}" border-top="{$wide-border-style}" number-columns-spanned="12">
							<fo:block start-indent="0mm">Standortmerkmale</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="center" border-left="{$wide-border-style}" border-top="{$wide-border-style}" number-columns-spanned="7">
							<fo:block start-indent="0mm">Konstruktive Merkmale</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="center" border-left="{$wide-border-style}" border-right="{$wide-border-style}" border-top="{$wide-border-style}" number-columns-spanned="4">
						...
						<fo:table-cell text-align="center" border-left="{$wide-border-style}" border-top="{$wide-border-style}" number-columns-spanned="15">
					...
					<fo:table-row >
						...
						<fo:table-cell text-align="center" border-left="{$wide-border-style}" number-rows-spanned="2" border-right="{$small-border-style}" border-top="{$small-border-style}">
							<fo:block start-indent="0mm">Reales Signal</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="center" border-right="{$wide-border-style}" number-rows-spanned="2" border-top="{$small-border-style}">
							<fo:block start-indent="0mm">Fiktives Signal</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="center" border-left="{$small-border-style}" border-top="{$small-border-style}" number-columns-spanned="2">
							<fo:block start-indent="0mm">Standort</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="center" border-left="{$small-border-style}" number-rows-spanned="2" border-top="{$small-border-style}">
...
Mastmitte - Gleismitte</fo:block>
						...
						<fo:table-cell text-align="center" border-left="{$small-border-style}" border-top="{$small-border-style}" number-columns-spanned="3">
							<fo:block start-indent="0mm">Sichtbarkeit</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="center" border-left="{$small-border-style}" border-right="{$wide-border-style}" border-top="{$small-border-style}" number-columns-spanned="2">
						...
						<fo:table-cell text-align="center" border-left="{$small-border-style}" border-top="{$small-border-style}">
							<fo:block start-indent="0mm">Separate Schaltkasten Steuerung</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="center" border-right="{$wide-border-style}" border-left="{$small-border-style}" number-rows-spanned="2" border-top="{$small-border-style}">
...
schaltung</fo:block>
						...
						<fo:table-cell text-align="center" border-left="{$wide-border-style}" border-top="{$small-border-style}" number-columns-spanned="5">
							<fo:block start-indent="0mm">Signalbegriffe
(Schirm)</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="center" border-left="{$small-border-style}" border-top="{$small-border-style}" number-columns-spanned="7">
							<fo:block start-indent="0mm">Signalbegriffe
(Zusatzanzeiger)</fo:block>
						...
						<fo:table-cell text-align="center" border-left="{$wide-border-style}" number-rows-spanned="2" border-top="{$small-border-style}">
						...
						<fo:table-cell text-align="center" border-left="{$small-border-style}" number-rows-spanned="2" border-right="{$small-border-style}" border-top="{$small-border-style}">
							<fo:block start-indent="0mm">Löschung Zs 1/Zs 7</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="center" border-right="{$wide-border-style}" border-top="{$small-border-style}" number-columns-spanned="2">
...
Nr. (Bild)</fo:block>
					...
					<fo:table-row >
						...
						<fo:table-cell text-align="center" border-left="{$small-border-style}" border-right="{$wide-border-style}" border-bottom="{$wide-border-style}" border-top="none">
							<fo:block start-indent="0mm"></fo:block>
						</fo:table-cell>
						<fo:table-cell xsl:use-attribute-sets="no-border-style" border-bottom="{$wide-border-style}">
							<fo:block start-indent="0mm"></fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="center" border-left="{$wide-border-style}" border-right="{$wide-border-style}" border-bottom="{$wide-border-style}" border-top="none">
							<fo:block start-indent="0mm"></fo:block>
						</fo:table-cell>
	...
	<xsl:template match="Cell[@column-number = '1' and ../@group-number != count(/Table/Rows/Row)]">
		<fo:table-cell xsl:use-attribute-sets="first-column-cell-style" border-right="{$wide-border-style}" number-rows-spanned="{@number-rows-spanned}">
			<xsl:apply-templates />
		</fo:table-cell>
	</xsl:template>
	...
	<xsl:template match="Cell[@column-number = '1' and ../@group-number = count(/Table/Rows/Row)]">
		<fo:table-cell xsl:use-attribute-sets="first-column-last-row-cell-style" border-right="{$wide-border-style}" number-rows-spanned="{@number-rows-spanned}">
			<xsl:apply-templates />
		</fo:table-cell>
	</xsl:template>
