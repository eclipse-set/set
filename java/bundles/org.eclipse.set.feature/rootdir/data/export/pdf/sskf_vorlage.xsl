	...
	<xsl:template match="Table[Rows/Row]">
		<fo:table table-layout="fixed" width="100%">
			...
			<!-- CUSTOMIZE: Adjust number of used columns and insert column width 
				from excel template. -->
			<fo:table-column column-number="1" column-width="0.66cm" /> <!-- A -->
			<fo:table-column column-number="2" column-width="2.83cm" /> <!-- B -->
			<fo:table-column column-number="3" column-width="1.14cm" /> <!-- C -->
			<fo:table-column column-number="4" column-width="1.14cm" /> <!-- D -->
			<fo:table-column column-number="5" column-width="1.22cm" /> <!-- E -->
			<fo:table-column column-number="6" column-width="2.59cm" /> <!-- F -->
			<fo:table-column column-number="7" column-width="1.69cm" /> <!-- G -->
			<fo:table-column column-number="8" column-width="1.43cm" /> <!-- H -->
			<fo:table-column column-number="9" column-width="1.43cm" /> <!-- I -->
			<fo:table-column column-number="10" column-width="3.28cm" /> <!-- J -->
			<fo:table-column column-number="11" column-width="1.14cm" /> <!-- K -->
			<fo:table-column column-number="12" column-width="1.14cm" /> <!-- L -->
			<fo:table-column column-number="13" column-width="1.14cm" /> <!-- M -->
			<fo:table-column column-number="14" column-width="1.14cm" /> <!-- N --> 
			<fo:table-column column-number="15" column-width="1.14cm" /> <!-- O -->
			<fo:table-column column-number="16" column-width="1.14cm" /> <!-- P -->
			<fo:table-column column-number="17" column-width="1.69cm" /> <!-- Q -->
			<fo:table-column column-number="18" column-width="1.69cm" /> <!-- R -->
			<fo:table-column column-number="19" column-width="1.69cm" /> <!-- S -->
			<fo:table-column column-number="20" column-width="1.43cm" /> <!-- T -->
			<fo:table-column column-number="21" column-width="1.43cm" /> <!-- U -->
			<fo:table-column column-number="22" column-width="1.43cm" /> <!-- V -->
			<fo:table-column column-number="23" column-width="5.35cm" /> <!-- W -->
			...
			<fo:table-header xsl:use-attribute-sets="table-header-style">
				...
				<fo:table-row>
					...
					<fo:table-cell
						 number-rows-spanned="2"  xsl:use-attribute-sets="thin-border-style">
						<fo:block>Art</fo:block>
					</fo:table-cell>
					<fo:table-cell 
						 number-columns-spanned="1" number-rows-spanned="2" xsl:use-attribute-sets="thin-border-style" border-right="{$wide-border-style}">
						<fo:block>Typ</fo:block>
					</fo:table-cell>
					<fo:table-cell 
						 number-columns-spanned="1"  number-rows-spanned="2" xsl:use-attribute-sets="thin-border-style">
						<fo:block>AEA</fo:block>
					</fo:table-cell>
					<fo:table-cell 
						 number-columns-spanned="3"  xsl:use-attribute-sets="thin-border-style" border-right="{$wide-border-style}">
						<fo:block>Übertragung</fo:block>
					</fo:table-cell>
					<fo:table-cell 
						 number-columns-spanned="4"  xsl:use-attribute-sets="thin-border-style" border-right="{$wide-border-style}">
...
meldung</fo:block>
				...
				<fo:table-row>
					...
					<fo:table-cell xsl:use-attribute-sets="thin-border-style"
						number-rows-spanned="1">
						<fo:block>l<fo:inline xsl:use-attribute-sets="subscripted-style">S</fo:inline></fo:block>
					</fo:table-cell>
					<fo:table-cell xsl:use-attribute-sets="thin-border-style" 
						number-rows-spanned="1">
						<fo:block>l<fo:inline xsl:use-attribute-sets="subscripted-style">1</fo:inline></fo:block>
					</fo:table-cell>
					<fo:table-cell xsl:use-attribute-sets="thin-border-style" 
						number-rows-spanned="1">
						<fo:block>l<fo:inline xsl:use-attribute-sets="subscripted-style">2</fo:inline></fo:block>
					</fo:table-cell><fo:table-cell xsl:use-attribute-sets="thin-border-style" border-right="{$wide-border-style}"
						number-rows-spanned="1">
						<fo:block>l<fo:inline xsl:use-attribute-sets="subscripted-style">3</fo:inline></fo:block>
					</fo:table-cell>
					<fo:table-cell xsl:use-attribute-sets="thin-border-style" 
						number-rows-spanned="1">
