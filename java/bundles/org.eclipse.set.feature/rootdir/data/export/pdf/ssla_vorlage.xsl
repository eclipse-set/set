...
<xsl:stylesheet version="2.0"
	...
	<xsl:template match="Table[Rows/Row]">
		<fo:table table-layout="fixed" width="100%">
			...
			<!--  -->
			<fo:table-column column-number="2" column-width="2.06cm" />
			<!-- A -->
			<fo:table-column column-number="3" column-width="1.14cm" />
			<!-- B -->
			<fo:table-column column-number="4" column-width="1.24cm" />
			<!-- C -->
			<fo:table-column column-number="5" column-width="1.01cm" />
			<!-- D -->
			<fo:table-column column-number="6" column-width="0.95cm" />
			<!-- E -->
			<fo:table-column column-number="7" column-width="9.26cm" />
			<!-- F -->
			<fo:table-column column-number="8" column-width="21.27cm" />
			<!-- G -->
			...
			<fo:table-header xsl:use-attribute-sets="table-header-style">
				...
				<fo:table-row font-weight="bold" display-align="before">
					...
					<fo:table-cell xsl:use-attribute-sets="thin-border-style" border-top="{$wide-border-style}" border-left="{$wide-border-style}" border-right="{$wide-border-style}" border-bottom="{$wide-border-style}" number-columns-spanned="5">
						<fo:block>Grundsatzangaben</fo:block>
					</fo:table-cell>
					<fo:table-cell xsl:use-attribute-sets="thin-border-style" border-top="{$wide-border-style}" border-right="{$wide-border-style}" number-rows-spanned="3">
...
(bei Zugstraßen mit D-Weg)</fo:block>
				...
				<fo:table-row>
					...
					<fo:table-cell xsl:use-attribute-sets="thin-border-style" column-number="3">
