...
<xsl:stylesheet version="2.0"
	...
	<xsl:template match="Table[Rows/Row]">
		<fo:table table-layout="fixed" width="100%">
			...
			<!--  -->
			<fo:table-column column-number="2" column-width="1.72cm" />
			<!-- A -->
			<fo:table-column column-number="3" column-width="1.93cm" />
			<!-- B -->
			<fo:table-column column-number="4" column-width="1.69cm" />
			<!-- C -->
			...
			<!-- G -->
			<fo:table-column column-number="9" column-width="2.12cm" />
			<!-- H -->
			<fo:table-column column-number="10" column-width="2.12cm" />
			<!-- I -->
			<fo:table-column column-number="11" column-width="2.12cm" />
			<!-- J -->
			<fo:table-column column-number="12" column-width="2.41cm" />
			<!-- K -->
			<fo:table-column column-number="13" column-width="0.95cm" />
			<!-- L -->
			<fo:table-column column-number="14" column-width="1.27cm" />
			<!-- M -->
			<fo:table-column column-number="15" column-width="1.19cm" />
			<!-- N -->
			<fo:table-column column-number="16" column-width="1.11cm" />
			<!-- O -->
			<fo:table-column column-number="17" column-width="1.27cm" />
			<!-- P -->
			<fo:table-column column-number="18" column-width="1.16cm" />
			<!-- Q -->
			<fo:table-column column-number="19" column-width="1.59cm" />
			<!-- R -->
			<fo:table-column column-number="20" column-width="2.28cm" />
			<!-- S -->
			<fo:table-column column-number="21" column-width="1.59cm" />
			<!-- T -->
			<fo:table-column column-number="22" column-width="2.28cm" />
			<!-- U -->
			<fo:table-column column-number="23" column-width="2.28cm" />
			<!-- V -->
			...
			<fo:table-header xsl:use-attribute-sets="table-header-style">
				...
				<fo:table-row>
					...
					<fo:table-cell number-columns-spanned="2" xsl:use-attribute-sets="no-border-style" border-right="{$small-border-style}">
