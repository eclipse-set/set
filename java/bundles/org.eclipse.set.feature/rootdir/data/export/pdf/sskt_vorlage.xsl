...
<xsl:stylesheet version="2.0"
	...
	<xsl:template match="Table[Rows/Row]">
		<fo:table table-layout="fixed" width="100%">
			...
			<!--  -->
			<fo:table-column column-number="2" column-width="2.35cm" />
			<!-- A -->
			<fo:table-column column-number="3" column-width="1.93cm" />
			<!-- B -->
			<fo:table-column column-number="4" column-width="1.85cm" />
			<!-- C -->
			<fo:table-column column-number="5" column-width="1.88cm" />
			<!-- D -->
			<fo:table-column column-number="6" column-width="2.91cm" />
			<!-- E -->
			<fo:table-column column-number="7" column-width="1.08cm" />
			<!-- F -->
			<fo:table-column column-number="8" column-width="1.14cm" />
			<!-- G -->
			<fo:table-column column-number="9" column-width="1.19cm" />
			<!-- H -->
			<fo:table-column column-number="10" column-width="2.49cm" />
			<!-- I -->
			<fo:table-column column-number="11" column-width="2.99cm" />
			<!-- J -->
			<fo:table-column column-number="12" column-width="2.49cm" />
			<!-- K -->
			<fo:table-column column-number="13" column-width="2.99cm" />
			<!-- L -->
			<fo:table-column column-number="14" column-width="1.93cm" />
			<!-- M -->
			<fo:table-column column-number="15" column-width="2.99cm" />
			<!-- N -->
			<fo:table-column column-number="16" column-width="2.99cm" />
			<!-- O -->
			<fo:table-column column-number="17" column-width="3.31cm" />
			<!-- P -->
			...
			<fo:table-header xsl:use-attribute-sets="table-header-style">
				...
				<fo:table-row font-weight="bold" display-align="before">
					...
					<fo:table-cell xsl:use-attribute-sets="thin-border-style" border-right="{$wide-border-style}" border-top="{$wide-border-style}" number-columns-spanned="8">
						<fo:block>IP-Adressangaben</fo:block>
					</fo:table-cell>
				...
				<fo:table-row>
					...
					<fo:table-cell xsl:use-attribute-sets="no-border-style" number-rows-spanned="2">
						<fo:block>Bezeichnung
TSO/BSO</fo:block>
					</fo:table-cell>
					<fo:table-cell xsl:use-attribute-sets="no-border-style" border-left="{$small-border-style}" number-rows-spanned="2">
						<fo:block>Art</fo:block>
					</fo:table-cell>
					<fo:table-cell number-rows-spanned="2" xsl:use-attribute-sets="no-border-style" border-left="{$small-border-style}">
						<fo:block>BSO</fo:block>
					</fo:table-cell>
					<fo:table-cell number-columns-spanned="4" xsl:use-attribute-sets="no-border-style" border-left="{$small-border-style}" border-right="{$wide-border-style}">
						<fo:block>Unterbringung</fo:block>
					</fo:table-cell>
					<fo:table-cell number-columns-spanned="1" number-rows-spanned="2" xsl:use-attribute-sets="no-border-style" border-right="{$small-border-style}">
						<fo:block>Regional- bereich</fo:block>
					</fo:table-cell>
					<fo:table-cell number-columns-spanned="2" xsl:use-attribute-sets="no-border-style">
						<fo:block>Blau</fo:block>
					</fo:table-cell>
					<fo:table-cell number-columns-spanned="2" xsl:use-attribute-sets="no-border-style" border-left="{$small-border-style}">
						<fo:block>Grau</fo:block>
					</fo:table-cell>
					<fo:table-cell number-columns-spanned="3" xsl:use-attribute-sets="no-border-style" border-left="{$small-border-style}" border-right="{$wide-border-style}">
						<fo:block>Teilsystem</fo:block>
					</fo:table-cell>
				</fo:table-row>
				<fo:table-row>
					<fo:table-cell xsl:use-attribute-sets="no-border-style" border-right="{$wide-border-style}">
					...
					<fo:table-cell xsl:use-attribute-sets="no-border-style" border-left="{$small-border-style}" number-rows-spanned="1">
						<fo:block>Art</fo:block>
					</fo:table-cell>
					<fo:table-cell xsl:use-attribute-sets="no-border-style" border-left="{$small-border-style}" number-columns-spanned="1">
						<fo:block>Ort</fo:block>
					</fo:table-cell>
					<fo:table-cell xsl:use-attribute-sets="no-border-style" border-left="{$small-border-style}" number-rows-spanned="1">
						<fo:block>Strecke</fo:block>
					</fo:table-cell>
					<fo:table-cell xsl:use-attribute-sets="no-border-style" border-left="{$small-border-style}" border-right="{$wide-border-style}" number-rows-spanned="1">
						<fo:block>km</fo:block>
					</fo:table-cell>
					<fo:table-cell xsl:use-attribute-sets="no-border-style" number-rows-spanned="1">
				...
				<fo:table-row>
					...
					<fo:table-cell xsl:use-attribute-sets="no-border-style" border-left="{$small-border-style}" border-bottom="{$wide-border-style}">
						<fo:block></fo:block>
					</fo:table-cell>
					<fo:table-cell xsl:use-attribute-sets="no-border-style" border-left="{$small-border-style}" border-bottom="{$wide-border-style}">
						<fo:block></fo:block>
					...
					<fo:table-cell xsl:use-attribute-sets="no-border-style" border-left="{$small-border-style}" border-bottom="{$wide-border-style}" border-right="{$wide-border-style}">
						<fo:block></fo:block>
					</fo:table-cell>
	...
	<xsl:template match="Cell[contains(' 15 ', concat(' ', @column-number, ' '))]" priority="1">
		<fo:table-cell xsl:use-attribute-sets="default-cell-style" border-right="{$wide-border-style}">
			<xsl:apply-templates />
		</fo:table-cell>
	</xsl:template>

	<xsl:template match="Cell[contains(' 15 ', concat(' ', @column-number, ' ')) and ../@group-number = count(/Table/Rows/Row)]" priority="2">
	...
	<xsl:template match="Cell[contains(' 1 16 ', concat(' ', @column-number, ' '))]" priority="3">
		<fo:table-cell xsl:use-attribute-sets="default-cell-style" text-align="left" number-rows-spanned="{@number-rows-spanned}">
			<xsl:apply-templates />
		</fo:table-cell>
	</xsl:template>

	<xsl:template match="Cell[contains(' 1 16 ', concat(' ', @column-number, ' ')) and ../@group-number = count(/Table/Rows/Row)]" priority="4">
