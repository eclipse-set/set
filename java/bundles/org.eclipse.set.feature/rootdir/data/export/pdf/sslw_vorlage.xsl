...
<xsl:stylesheet version="2.0"
	...
	<xsl:template match="Table[Rows/Row]">
		<fo:table table-layout="fixed" width="100%">
			...
			<!-- group number -->
			<fo:table-column column-number="2" column-width="2.34cm" />
			<!-- A -->
			<fo:table-column column-number="3" column-width="0.85cm" />
			<!-- B -->
			<fo:table-column column-number="4" column-width="0.71cm" />
			<!-- C -->
			<fo:table-column column-number="5" column-width="1.61cm" />
			<!-- D -->
			<fo:table-column column-number="6" column-width="1.69cm" />
			<!-- E -->
			<fo:table-column column-number="7" column-width="0.77cm" />
			<!-- F -->
			<fo:table-column column-number="8" column-width="1.56cm" />
			<!-- G -->
			<fo:table-column column-number="9" column-width="1.69cm" />
			<!-- H -->
			<fo:table-column column-number="10" column-width="1.64cm" />
			<!-- I -->
			<fo:table-column column-number="11" column-width="1.69cm" />
			<!-- J -->
			<fo:table-column column-number="12" column-width="1.24cm" />
			<!-- K -->
			<fo:table-column column-number="13" column-width="1.69cm" />
			<!-- L -->
			<fo:table-column column-number="14" column-width="1.22cm" />
			<!-- M -->
			<fo:table-column column-number="15" column-width="1.75cm" />
			<!-- N -->
			<fo:table-column column-number="16" column-width="1.56cm" />
			<!-- O -->
			<fo:table-column column-number="17" column-width="1.8cm" />
			<!-- P -->
			<fo:table-column column-number="18" column-width="1.98cm" />
			<!-- Q -->
			<fo:table-column column-number="19" column-width="12.69cm" />
			<!-- R -->
			...
			<fo:table-header xsl:use-attribute-sets="table-header-style">
				...
				<fo:table-row font-weight="bold" display-align="before">
					...
					<fo:table-cell number-columns-spanned="1" number-rows-spanned="3" xsl:use-attribute-sets="thin-border-style" border-top="{$wide-border-style}" border-right="{$wide-border-style}">
						<fo:block>Weiche/Kreuzung in angeforderter Stellung</fo:block>
					</fo:table-cell>
					<fo:table-cell number-columns-spanned="2" border-right="{$wide-border-style}" border-top="{$wide-border-style}">
						<fo:block>Art</fo:block>
					</fo:table-cell>
					<fo:table-cell number-columns-spanned="1" number-rows-spanned="3" border-right="{$wide-border-style}" border-top="{$wide-border-style}">
						<fo:block>Verschluss</fo:block>
					</fo:table-cell>
					<fo:table-cell number-columns-spanned="5" border-right="{$wide-border-style}" border-top="{$wide-border-style}">
						<fo:block>Ersatzschutz unmittelbar</fo:block>
					</fo:table-cell>
					<fo:table-cell number-columns-spanned="4" border-right="{$wide-border-style}" border-top="{$wide-border-style}">
						<fo:block>Ersatzschutz Weitergabe</fo:block>
					</fo:table-cell>
					<fo:table-cell number-columns-spanned="1" number-rows-spanned="3" border-right="{$wide-border-style}" border-top="{$wide-border-style}">
						<fo:block>Technischer Verzicht</fo:block>
					</fo:table-cell>
					<fo:table-cell number-columns-spanned="2" number-rows-spanned="1" border-right="{$wide-border-style}" border-top="{$wide-border-style}">
...
zielsperre</fo:block>
	...
	<xsl:template match="Cell[contains(' 1 18 ', concat(' ', @column-number, ' '))]" priority="3">
		<fo:table-cell xsl:use-attribute-sets="default-cell-style" text-align="left" border-right="{$wide-border-style}" number-rows-spanned="{@number-rows-spanned}">
			<xsl:apply-templates />
		</fo:table-cell>
	</xsl:template>

	<xsl:template match="Cell[contains(' 1 18 ', concat(' ', @column-number, ' ')) and ../@group-number = count(/Table/Rows/Row)]" priority="3">
		<fo:table-cell xsl:use-attribute-sets="last-row-cell-style" text-align="left" border-right="{$wide-border-style}" number-rows-spanned="{@number-rows-spanned}">
			<xsl:apply-templates />
		</fo:table-cell>
	</xsl:template>
</xsl:stylesheet>
