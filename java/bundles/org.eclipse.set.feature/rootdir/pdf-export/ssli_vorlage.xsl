...
<xsl:stylesheet version="2.0"
	...
	<xsl:template match="Table[Rows/Row]">
		<fo:table table-layout="fixed" width="100%">
			...
			<fo:table-column column-number="2" column-width="1.98cm" /> <!-- A -->
			<fo:table-column column-number="3" column-width="1.69cm" /> <!-- B -->
			<fo:table-column column-number="4" column-width="1.85cm" /> <!-- C -->
			<fo:table-column column-number="5" column-width="1.85cm" /> <!-- D -->
			<fo:table-column column-number="6" column-width="2.14cm" /> <!-- E -->
			<fo:table-column column-number="7" column-width="1.93cm" /> <!-- F -->
			<fo:table-column column-number="8" column-width="1.93cm" /> <!-- G -->
			<fo:table-column column-number="9" column-width="25.13cm" /> <!-- H -->
			...
			<fo:table-header xsl:use-attribute-sets="table-header-style">
				...
				<fo:table-row font-weight="bold" display-align="before">
					...
					<fo:table-cell xsl:use-attribute-sets="thin-border-style"
					number-columns-spanned="4" border-top="{$wide-border-style}" border-left="{$wide-border-style}" border-right="{$wide-border-style}">
						<fo:block>Grundsatzangaben</fo:block>
					</fo:table-cell>
					<fo:table-cell xsl:use-attribute-sets="thin-border-style"
					number-columns-spanned="3" border-top="{$wide-border-style}" border-right="{$wide-border-style}">
						<fo:block>Ausschluss gleichzeitiger Fahrten</fo:block>
					</fo:table-cell>
					<fo:table-cell xsl:use-attribute-sets="thin-border-style" border-right="{$wide-border-style}" number-rows-spanned="3"
				...
				<fo:table-row>
					...
					<fo:table-cell xsl:use-attribute-sets="thin-border-style"
						number-columns-spanned="2" border-right="{$wide-border-style}">
				...
				<fo:table-row>
					...
					<fo:table-cell xsl:use-attribute-sets="thin-border-style"
						number-columns-spanned="1" border-right="{$wide-border-style}">
