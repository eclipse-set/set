...
<xsl:stylesheet version="2.0"
	...
	<xsl:template match="Table[Rows/Row]">
		<fo:table table-layout="fixed" width="100%">
			...
			<fo:table-column column-number="2" column-width="1.27cm" /> <!-- A -->
			<fo:table-column column-number="3" column-width="1.59cm" /> <!-- B -->
			<fo:table-column column-number="4" column-width="1.59cm" /> <!-- C -->
			<fo:table-column column-number="5" column-width="1.59cm" /> <!-- D -->
			<fo:table-column column-number="6" column-width="1.69cm" /> <!-- E -->
			<fo:table-column column-number="7" column-width="1.1cm" /> <!-- F -->
			<fo:table-column column-number="8" column-width="0.64cm" /> <!-- G -->
			<fo:table-column column-number="9" column-width="0.64cm" /> <!-- H -->
			<fo:table-column column-number="10" column-width="1.75cm" /> <!-- I -->
			<fo:table-column column-number="11" column-width="1.74cm" /> <!-- J -->
			<fo:table-column column-number="12" column-width="1.53cm" /> <!-- K -->
			<fo:table-column column-number="13" column-width="1.53cm" /> <!-- L -->
			<fo:table-column column-number="14" column-width="1.27cm" /> <!-- M -->
			<fo:table-column column-number="15" column-width="1.51cm" /> <!-- N -->
			<fo:table-column column-number="16" column-width="1.38cm" /> <!-- O -->
			<fo:table-column column-number="17" column-width="1.11cm" /> <!-- P -->
			<fo:table-column column-number="18" column-width="2.2cm" /> <!-- Q -->
			<fo:table-column column-number="19" column-width="2.2cm" /> <!-- R -->
			<fo:table-column column-number="20" column-width="2.28cm" /> <!-- S -->
			<fo:table-column column-number="21" column-width="9.76cm" /> <!-- T -->
			...
			<fo:table-header xsl:use-attribute-sets="table-header-style">
				...
				<fo:table-row font-weight="bold" display-align="before">
					...
					<fo:table-cell xsl:use-attribute-sets="thin-border-style"
						border-right="{$wide-border-style}" number-columns-spanned="5"
