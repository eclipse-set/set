...
<xsl:stylesheet version="2.0"
	...
	<xsl:template match="Table[Rows/Row]">
		<fo:table table-layout="fixed" width="100%">
			...
			<fo:table-column column-number="2" column-width="1.88cm" /> <!-- A -->
			<fo:table-column column-number="3" column-width="0.95cm" /> <!-- B -->
			<fo:table-column column-number="4" column-width="1.40cm" /> <!-- C -->
			<fo:table-column column-number="5" column-width="1.56cm" /> <!-- D -->
			<fo:table-column column-number="6" column-width="2.30cm" /> <!-- E -->
			<fo:table-column column-number="7" column-width="4.60cm" /> <!-- F -->
			<fo:table-column column-number="8" column-width="3.25cm" /> <!-- G -->
			<fo:table-column column-number="9" column-width="1.72cm" /> <!-- H -->
			<fo:table-column column-number="10" column-width="3.25cm" /> <!-- I -->
			<fo:table-column column-number="11" column-width="1.32cm" /> <!-- J -->
			<fo:table-column column-number="12" column-width="3.02cm" /> <!-- K -->
			<fo:table-column column-number="13" column-width="2.28cm" /> <!-- L -->
			<fo:table-column column-number="14" column-width="2.65cm" /> <!-- M -->
			<fo:table-column column-number="15" column-width="7.83cm" /> <!-- N -->
			...
			<fo:table-header xsl:use-attribute-sets="table-header-style">
				...
				<fo:table-row font-weight="bold" display-align="before">
					...
					<fo:table-cell xsl:use-attribute-sets="thin-border-style"
						border-right="{$wide-border-style}" number-columns-spanned="2"
					...
					<fo:table-cell xsl:use-attribute-sets="thin-border-style"
						border-right="{$wide-border-style}" border-top="{$wide-border-style}"
						border-bottom="none" number-rows-spanned="3">
				...
				<fo:table-row display-align="before">
					...
					<fo:table-cell xsl:use-attribute-sets="thin-border-style"
						border-right="{$wide-border-style}" border-bottom="none">
...
(Element innen, außen)</fo:block>
					...
					<fo:table-cell xsl:use-attribute-sets="thin-border-style"
						border-bottom="none" number-columns-spanned="2">
					...
					<fo:table-cell xsl:use-attribute-sets="thin-border-style"
						border-bottom="none" number-columns-spanned="1" number-rows-spanned="2">
						<fo:block>Schlüsselsperre</fo:block>
					</fo:table-cell>
					<fo:table-cell xsl:use-attribute-sets="thin-border-style"
						border-right="{$wide-border-style}" border-bottom="none"
						number-columns-spanned="1" number-rows-spanned="2">
				...
				<fo:table-row display-align="before">
					...
					<fo:table-cell xsl:use-attribute-sets="thin-border-style"
						number-rows-spanned="2" border-top="none"
						border-bottom="{$wide-border-style}">
						<fo:block></fo:block>
					</fo:table-cell>
					<fo:table-cell xsl:use-attribute-sets="thin-border-style"
						number-rows-spanned="2" border-top="none"
						border-right="{$wide-border-style}" border-bottom="{$wide-border-style}">
						<fo:block></fo:block>
					</fo:table-cell>
					<fo:table-cell xsl:use-attribute-sets="thin-border-style"
						number-rows-spanned="2" border-top="none"
...
(Rückgabevoraussetzung)</fo:block>
				...
				<fo:table-row>
					...
					<fo:table-cell xsl:use-attribute-sets="no-border-style"
						border-right="{$small-border-style}" border-bottom="{$wide-border-style}">
						<fo:block></fo:block>
					</fo:table-cell>
					<fo:table-cell xsl:use-attribute-sets="no-border-style"
						border-right="{$small-border-style}" border-bottom="{$wide-border-style}">
