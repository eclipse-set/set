...
<xsl:stylesheet version="2.0"
	...
	<xsl:template match="Table[Rows/Row]">
		<fo:table table-layout="fixed" width="100%">
			...
			<fo:table-column column-number="2" column-width="1.67cm" /> <!-- A -->
			<fo:table-column column-number="3" column-width="1.08cm" /> <!-- B -->
			<fo:table-column column-number="4" column-width="2.06cm" /> <!-- C -->
			<fo:table-column column-number="5" column-width="1.69cm" /> <!-- D -->
			<fo:table-column column-number="6" column-width="1.16cm" /> <!-- E -->
			<fo:table-column column-number="7" column-width="1.06cm" /> <!-- F -->
			<fo:table-column column-number="8" column-width="2.28cm" /> <!-- G -->
			<fo:table-column column-number="9" column-width="2.28cm" /> <!-- H -->
			<fo:table-column column-number="10" column-width="1.69cm" /> <!-- I -->
			<fo:table-column column-number="11" column-width="1.59cm" /> <!-- J -->
			<fo:table-column column-number="12" column-width="2.38cm" /> <!-- K -->
			<fo:table-column column-number="13" column-width="2.41cm" /> <!-- L -->
			<fo:table-column column-number="14" column-width="1.64cm" /> <!-- M -->
			<fo:table-column column-number="15" column-width="1.11cm" /> <!-- N -->
			<fo:table-column column-number="16" column-width="2.06cm" /> <!-- O -->
			<fo:table-column column-number="17" column-width="1.61cm" /> <!-- P -->
			<fo:table-column column-number="18" column-width="1.14cm" /> <!-- Q -->
			<fo:table-column column-number="19" column-width="1.14cm" /> <!-- R -->
			<fo:table-column column-number="20" column-width="2.28cm" /> <!-- S -->
			<fo:table-column column-number="21" column-width="2.28cm" /> <!-- T -->
			<fo:table-column column-number="22" column-width="3.73cm" /> <!-- U -->
			...
			<fo:table-header xsl:use-attribute-sets="table-header-style">
				...
				<fo:table-row font-weight="bold" display-align="before">
					...
					<fo:table-cell xsl:use-attribute-sets="no-border-style" border-right="{$wide-border-style}"  border-top="{$wide-border-style}"
...
an</fo:block>
					...
					<fo:table-cell
						 number-rows-spanned="2"  xsl:use-attribute-sets="no-border-style" border-right="{$small-border-style}">
						<fo:block>Bezeichnung</fo:block>
					</fo:table-cell>
					<fo:table-cell 
						 number-columns-spanned="1"  xsl:use-attribute-sets="no-border-style" border-right="{$small-border-style}" number-rows-spanned="2">
						<fo:block>Bartform</fo:block>
					</fo:table-cell>
					<fo:table-cell 
						 number-columns-spanned="1" number-rows-spanned="2" xsl:use-attribute-sets="no-border-style" border-right="{$wide-border-style}">
						<fo:block>Gruppe</fo:block>
					</fo:table-cell>
					<fo:table-cell 
						 number-columns-spanned="2"  xsl:use-attribute-sets="no-border-style" border-right="{$wide-border-style}">
						<fo:block>Bezeichnung</fo:block>
					</fo:table-cell>
					<fo:table-cell 
						 number-columns-spanned="3"  xsl:use-attribute-sets="no-border-style">
						<fo:block>Verschlossenes Element </fo:block>
					</fo:table-cell>
					<fo:table-cell 
						 number-columns-spanned="1"  xsl:use-attribute-sets="no-border-style"  number-rows-spanned="2" border-left="{$small-border-style}" border-right="{$wide-border-style}">
