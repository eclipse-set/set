...
<xsl:stylesheet version="2.0"
	...
	<xsl:template match="Table[Rows/Row]">
		<fo:table table-layout="fixed" width="100%">
			...
			<fo:table-column column-number="14" column-width="1.67cm" /> <!-- M -->
			<fo:table-column column-number="15" column-width="1.69cm" /> <!-- N -->
			<fo:table-column column-number="16" column-width="1.69cm" /> <!-- O -->
			<fo:table-column column-number="17" column-width="2.28cm" /> <!-- P -->
			<fo:table-column column-number="18" column-width="1.85cm" /> <!-- Q -->
			<fo:table-column column-number="19" column-width="3.78cm" /> <!-- R -->
			...
			<fo:table-header xsl:use-attribute-sets="table-header-style">
				...
				<fo:table-row>
					...
					<fo:table-cell xsl:use-attribute-sets="thin-border-style" border-right="{$wide-border-style}"
						border-bottom="none" number-columns-spanned="3">
					...
					<fo:table-cell xsl:use-attribute-sets="thin-border-style" border-right="{$wide-border-style}"
						border-bottom="none" number-columns-spanned="8">
...
Hupe</fo:block>
	...
	<xsl:template match="Cell[contains(' 6 ', concat(' ', @column-number, ' ')) and ../@group-number = count(/Table/Rows/Row)]"
		priority="2">
	...
	<xsl:template match="Cell[contains(' 17 ', concat(' ', @column-number, ' ')) and ../@group-number = count(/Table/Rows/Row)]"
		priority="2">
		<fo:table-cell xsl:use-attribute-sets="last-row-cell-style" border-right="{$wide-border-style}">
			<xsl:apply-templates />
		</fo:table-cell>
