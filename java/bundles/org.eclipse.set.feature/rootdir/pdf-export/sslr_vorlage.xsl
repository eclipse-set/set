...
<xsl:stylesheet version="2.0"
	...
	<xsl:template match="Table[Rows/Row]">
		<fo:table table-layout="fixed" width="100%">
			...
			<fo:table-column column-number="2" column-width="2.73cm" /> <!-- A -->
			...
			<fo:table-column column-number="6" column-width="2.75cm" /> <!-- E -->
			<fo:table-column column-number="7" column-width="0.64cm" /> <!-- F -->
			<fo:table-column column-number="8" column-width="1.77cm" /> <!-- G -->
			<fo:table-column column-number="9" column-width="1.43cm" /> <!-- H -->
			<fo:table-column column-number="10" column-width="1.64cm" /> <!-- I -->
			<fo:table-column column-number="11" column-width="1.64cm" /> <!-- J -->
			<fo:table-column column-number="12" column-width="1.43cm" /> <!-- K -->
			<fo:table-column column-number="13" column-width="2.33cm" /> <!-- L -->
			<fo:table-column column-number="14" column-width="2.35cm" /> <!-- M -->
			<fo:table-column column-number="15" column-width="1.51cm" /> <!-- N -->
			<fo:table-column column-number="16" column-width="1.32cm" /> <!-- O -->
			<fo:table-column column-number="17" column-width="2.33cm" /> <!-- P -->
			<fo:table-column column-number="18" column-width="10.13cm" /> <!-- Q -->
			...
			<fo:table-header xsl:use-attribute-sets="table-header-style">
				...
				<fo:table-row>
					...
					<fo:table-cell
						 number-rows-spanned="2"  xsl:use-attribute-sets="thin-border-style" border-bottom="none">
						<fo:block>Autom.
Einstellung</fo:block>
					</fo:table-cell>
					<fo:table-cell
						 number-rows-spanned="2"  xsl:use-attribute-sets="thin-border-style" border-right="{$wide-border-style}" border-bottom="none">
						<fo:block>F-
Bedienung</fo:block>
					</fo:table-cell>
					<fo:table-cell
						number-columns-spanned="2" number-rows-spanned="1"  xsl:use-attribute-sets="thin-border-style" border-bottom="none">
