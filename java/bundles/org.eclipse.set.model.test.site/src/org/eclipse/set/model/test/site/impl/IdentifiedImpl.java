 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.set.model.test.site.impl.IdentifiedImpl#getGuid <em>Guid</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IdentifiedImpl extends MinimalEObjectImpl.Container implements Identified {
	...
	protected EClass eStaticClass() {
		return SitePackage.Literals.IDENTIFIED;
	}
	...
	public void setGuid(String newGuid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SitePackage.IDENTIFIED__GUID, oldGuid, guid));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SitePackage.IDENTIFIED__GUID:
				return getGuid();
		}
