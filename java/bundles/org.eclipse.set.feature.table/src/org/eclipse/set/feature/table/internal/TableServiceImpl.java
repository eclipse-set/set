...
public final class TableServiceImpl implements TableService {
	...
	private final TableDiffService diffService;
	...
	@Inject
	private TableServiceImpl(final TableDiffService diffService,
			final IEventBroker broker, final CacheService cacheService,
			final Messages messages, final ToolboxPartService partService,
