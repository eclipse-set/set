...
/**
 * Adds the group group grouping functionality to the column headers.
 * 
 * @author Schaefer
 */
public class ColumnGroupGroupGroupHeaderLayer extends AbstractLayerTransform {
	 ...
	 */
	public ColumnGroupGroupGroupHeaderLayer(
		...
		super(columnGroupGroupHeaderLayer);
	...
	public ILayerCell getCellByPosition(final int columnPosition,
		...
		if (rowPosition == 0) {
			...
			final ILayerCell underlyingCell = this.columnGroupGroupHeaderLayer
	...
	public LabelStack getConfigLabelsByPosition(final int columnPosition,
		...
		return this.columnGroupGroupHeaderLayer
	...
	@Override
	public String getDisplayModeByPosition(final int columnPosition,
			final int rowPosition) {
		final int columnIndex = getColumnIndexByPosition(columnPosition);
	...
	public int getHeight() {
		return this.rowHeightConfig.getAggregateSize(1)
				+ this.columnGroupGroupHeaderLayer.getHeight();
	}

	@Override
	public int getPreferredHeight() {
		return this.rowHeightConfig.getAggregateSize(1)
				+ this.columnGroupGroupHeaderLayer.getPreferredHeight();
	}
	...
	public LabelStack getRegionLabelsByXY(final int x, final int y) {
		...
		return this.columnGroupGroupHeaderLayer.getRegionLabelsByXY(x,
				y - getRowHeightByPosition(0));
	}

	@Override
	public int getRowCount() {
		return this.columnGroupGroupHeaderLayer.getRowCount() + 1;
	}
	...
	public int getRowPositionByY(final int y) {
		...
		return 1 + this.columnGroupGroupHeaderLayer
	...
	public int getStartYOfRowPosition(final int rowPosition) {
		...
		return getRowHeightByPosition(0) + this.columnGroupGroupHeaderLayer
				.getStartYOfRowPosition(rowPosition - 1);
	}

	/**
	 * @param bodyColumnIndex
	 *            the body column index
	 * 
	 * @return whether the column is in a group
	 */
