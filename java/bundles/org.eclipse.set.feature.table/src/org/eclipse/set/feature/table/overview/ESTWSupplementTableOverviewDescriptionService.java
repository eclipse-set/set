...
public class ESTWSupplementTableOverviewDescriptionService
	...
	public PartDescription getDescription(final IEclipseContext context) {
		...
		return new PartDescription(
				// ID
				String.format("%s.%s", ESTW_SUPPLEMENT_PART_ID_PREFIX, //$NON-NLS-1$
						TABLE_OVERVIEW_ID),
				// contributionURI
				"bundleclass://org.eclipse.set.feature.table/org.eclipse.set.feature.table.overview.TableOverviewPart", //$NON-NLS-1$
				// toolboxViewName
				injectionHelper.messages.ESTW_Supplement_TableOverviewDescriptionService_ViewName,
				// toolboxViewToolTip
				"", //$NON-NLS-1$
				// toolboxViewType
				getToolboxViewGroup(),
