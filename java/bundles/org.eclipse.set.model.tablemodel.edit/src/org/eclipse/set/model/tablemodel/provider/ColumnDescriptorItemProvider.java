 ...
 * {@link org.eclipse.set.model.tablemodel.ColumnDescriptor} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class ColumnDescriptorItemProvider extends ItemProviderAdapter
	...
	protected void addWidthPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_ColumnDescriptor_width_feature",
						"_UI_ColumnDescriptor_type"),
				TablemodelPackage.Literals.COLUMN_DESCRIPTOR__WIDTH, true,
	...
	protected void addWidthModePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_ColumnDescriptor_widthMode_feature",
						"_UI_ColumnDescriptor_type"),
				TablemodelPackage.Literals.COLUMN_DESCRIPTOR__WIDTH_MODE, true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addChildrenPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_ColumnDescriptor_children_feature",
						"_UI_ColumnDescriptor_type"),
				TablemodelPackage.Literals.COLUMN_DESCRIPTOR__CHILDREN, true,
	...
	protected void addLabelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_ColumnDescriptor_label_feature",
						"_UI_ColumnDescriptor_type"),
				TablemodelPackage.Literals.COLUMN_DESCRIPTOR__LABEL, true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addGreyedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_ColumnDescriptor_greyed_feature",
						"_UI_ColumnDescriptor_type"),
				TablemodelPackage.Literals.COLUMN_DESCRIPTOR__GREYED, true,
	...
	protected void addUnitPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_ColumnDescriptor_unit_feature",
						"_UI_ColumnDescriptor_type"),
				TablemodelPackage.Literals.COLUMN_DESCRIPTOR__UNIT, true, false,
	...
	protected void addParentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_ColumnDescriptor_parent_feature",
						"_UI_ColumnDescriptor_type"),
				TablemodelPackage.Literals.COLUMN_DESCRIPTOR__PARENT, true,
				false, true, null, null, null));
	}
	...
	protected void addHeightPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_ColumnDescriptor_height_feature",
						"_UI_ColumnDescriptor_type"),
				TablemodelPackage.Literals.COLUMN_DESCRIPTOR__HEIGHT, true,
	...
	protected void addMergeCommonValuesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_ColumnDescriptor_mergeCommonValues_feature",
						"_UI_ColumnDescriptor_type"),
	...
	protected void addColumnPositionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_ColumnDescriptor_columnPosition_feature",
						"_UI_ColumnDescriptor_type"),
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/ColumnDescriptor"));
	}
