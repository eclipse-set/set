...
/**
 * This is the item provider adapter for a {@link org.eclipse.set.model.tablemodel.RowGroup} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RowGroupItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_RowGroup_leadingObject_feature", "_UI_RowGroup_type"),
				 TablemodelPackage.Literals.ROW_GROUP__LEADING_OBJECT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_RowGroup_leadingObjectIndex_feature", "_UI_RowGroup_type"),
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RowGroup"));
	}
	...
	public String getText(Object object) {
		...
		return getString("_UI_RowGroup_type") + " " + rowGroup.getLeadingObjectIndex();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TablemodelPackage.Literals.ROW_GROUP__ROWS,
