...
/**
 * This is the item provider adapter for a {@link org.eclipse.set.model.integrationview.Conflict} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConflictItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Conflict_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Conflict_id_feature", "_UI_Conflict_type"),
				 IntegrationviewPackage.Literals.CONFLICT__ID,
				 true,
				 false,
				 false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Conflict_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Conflict_name_feature", "_UI_Conflict_type"),
				 IntegrationviewPackage.Literals.CONFLICT__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Conflict_container_feature", "_UI_Conflict_type"),
				 IntegrationviewPackage.Literals.CONFLICT__CONTAINER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Conflict_version_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Conflict_version_feature", "_UI_Conflict_type"),
				 IntegrationviewPackage.Literals.CONFLICT__VERSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Conflict_resolution_feature", "_UI_Conflict_type"),
				 IntegrationviewPackage.Literals.CONFLICT__RESOLUTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(IntegrationviewPackage.Literals.CONFLICT__DETAILS);
		}
