 ...
 * @generated
 */
public class ToolboxTemporaryIntegrationItemProvider extends ItemProviderAdapter
	 ...
	 * @generated
	 */
	public ToolboxTemporaryIntegrationItemProvider(
	...
	protected void addPrimaryPlanningFilenamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getResourceLocator(),
				getString(
						"_UI_ToolboxTemporaryIntegration_primaryPlanningFilename_feature"),
	...
	protected void addPrimaryPlanningWasValidPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getResourceLocator(),
				getString(
						"_UI_ToolboxTemporaryIntegration_primaryPlanningWasValid_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_ToolboxTemporaryIntegration_primaryPlanningWasValid_feature",
						"_UI_ToolboxTemporaryIntegration_type"),
	...
	/**
	 * This adds a property descriptor for the Primary Planning ID References
	 * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addPrimaryPlanningIDReferencesPropertyDescriptor(
			Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(),
				getResourceLocator(),
				getString(
						"_UI_ToolboxTemporaryIntegration_primaryPlanningIDReferences_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_ToolboxTemporaryIntegration_primaryPlanningIDReferences_feature",
						"_UI_ToolboxTemporaryIntegration_type"),
	...
	protected void addSecondaryPlanningFilenamePropertyDescriptor(
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getResourceLocator(),
				getString(
						"_UI_ToolboxTemporaryIntegration_secondaryPlanningFilename_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_ToolboxTemporaryIntegration_secondaryPlanningFilename_feature",
						"_UI_ToolboxTemporaryIntegration_type"),
	...
	protected void addSecondaryPlanningWasValidPropertyDescriptor(
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getResourceLocator(),
				getString(
						"_UI_ToolboxTemporaryIntegration_secondaryPlanningWasValid_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_ToolboxTemporaryIntegration_secondaryPlanningWasValid_feature",
						"_UI_ToolboxTemporaryIntegration_type"),
	...
	/**
	 * This adds a property descriptor for the Secondary Planning ID References
	 * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addSecondaryPlanningIDReferencesPropertyDescriptor(
			Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(),
				getResourceLocator(),
				getString(
						"_UI_ToolboxTemporaryIntegration_secondaryPlanningIDReferences_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_ToolboxTemporaryIntegration_secondaryPlanningIDReferences_feature",
						"_UI_ToolboxTemporaryIntegration_type"),
	...
	/**
	 * This adds a property descriptor for the Composite Planning ID References
	 * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addCompositePlanningIDReferencesPropertyDescriptor(
			Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(),
				getResourceLocator(),
				getString(
						"_UI_ToolboxTemporaryIntegration_compositePlanningIDReferences_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_ToolboxTemporaryIntegration_compositePlanningIDReferences_feature",
						"_UI_ToolboxTemporaryIntegration_type"),
	...
	protected void addIntegrationDirectoryPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getResourceLocator(),
				getString(
						"_UI_ToolboxTemporaryIntegration_integrationDirectory_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_ToolboxTemporaryIntegration_integrationDirectory_feature",
						"_UI_ToolboxTemporaryIntegration_type"),
	...
	/**
	 * This returns ToolboxTemporaryIntegration.gif. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator()
				.getImage("full/obj16/ToolboxTemporaryIntegration"));
	}
	...
	public String getText(Object object) {
		String label = ((ToolboxTemporaryIntegration) object)
	...
	public String getCreateChildText(Object owner, Object feature, Object child,
		...
		boolean qualify = childFeature == TemporaryintegrationPackage.Literals.TOOLBOX_TEMPORARY_INTEGRATION__PRIMARY_PLANNING
