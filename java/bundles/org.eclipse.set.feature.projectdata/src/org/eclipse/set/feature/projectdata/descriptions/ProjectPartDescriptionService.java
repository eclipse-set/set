...
/**
 * Part description for edit project view.
 * 
 * @author Schaefer
 */
@Component
public class ProjectPartDescriptionService implements PartDescriptionService {
	...
	public PartDescription getDescription(final IEclipseContext context) {
		...
		return new PartDescription(
				// ID
				ToolboxConstants.PROJECT_PART_ID,
				// contributionURI
				"bundleclass://org.eclipse.set.feature.projectdata/org.eclipse.set.feature.projectdata.edit.ProjectPart", //$NON-NLS-1$
				// toolboxViewName
				injectionHelper.messages.ProjectPartDescriptionService_ViewName,
				// toolboxViewToolTip
				"", //$NON-NLS-1$
				// toolboxViewType
				getToolboxViewGroup(),
